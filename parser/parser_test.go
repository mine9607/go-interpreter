...
func TestIdentifierExpression(t *testing.T) {
	...
	// Note: the syntax program.Statements[0].(*ast.Expressionstatment) is TYPE ASSERTION
	// the .(*ast.ExpressionStatement) checks if program.Statements[0] is of type ExpressionStatement (from *ast)
	...
	// type assertion that type ExpressionStatment's property Expression is of type Identifier
	...
	if ident.TokenLiteral() != "foobar" {
		t.Errorf("ident.TokenLiteal not %s. got=%s", "foobar", ident.TokenLiteral())
	}
}
